package com.hoangdp.heodat.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.hoangdp.heodat.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.hoangdp.heodat.security.DomainUserDetailsService", "createSpringSecurityUser");
