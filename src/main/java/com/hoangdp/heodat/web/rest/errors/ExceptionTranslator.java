package com.hoangdp.heodat.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.hoangdp.heodat.service.EmailAlreadyUsedException ||
            ex instanceof com.hoangdp.heodat.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.hoangdp.heodat.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.hoangdp.heodat");
    }
}
